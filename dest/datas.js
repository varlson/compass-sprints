export const posts = [
    {
        id: 1,
        title: "UFOP fica na 31ª posição entre as federais do país no IGC e é a 7ª em MG",
...
export function buildTemplate(post) {
    const template = ` <div id="1" class="card-item">
...
export function buildItemTemplate(id) {
    const template = `
